...
cat("[stats] 00_grain_definition\n")
source("pipelines/05_performance/00_schema/00_grain_definition.R")
cat("[stats] 01_column_dictionary\n")
suppressMessages(source("pipelines/05_performance/00_schema/01_column_dictionary.R"))

cat("[stats] 01_mlb_offense_season\n")
suppressMessages(source("pipelines/05_performance/01_offense/01_mlb_offense_season.R"))
cat("[stats] 02_fangraphs_offense_season\n")
suppressMessages(source("pipelines/05_performance/01_offense/02_fangraphs_offense_season.R"))
cat("[stats] 04_mlb_offense_splits\n")
suppressMessages(source("pipelines/05_performance/01_offense/04_mlb_offense_splits.R"))
cat("[stats] 99_offense_master_join\n")
suppressMessages(source("pipelines/05_performance/01_offense/99_offense_master_join.R"))
cat("[stats] 06_player_career_offense\n")
suppressMessages(source("pipelines/05_performance/01_offense/06_player_career_offense.R"))

cat("[stats] 01_mlb_pitching_season\n")
suppressMessages(source("pipelines/05_performance/02_pitching/01_mlb_pitching_season.R"))
cat("[stats] 02_fangraphs_pitching_season\n")
suppressMessages(source("pipelines/05_performance/02_pitching/02_fangraphs_pitching_season.R"))
cat("[stats] 04_mlb_pitching_splits\n")
suppressMessages(source("pipelines/05_performance/02_pitching/04_mlb_pitching_splits.R"))
cat("[stats] 99_pitching_master_join\n")
suppressMessages(source("pipelines/05_performance/02_pitching/99_pitching_master_join.R"))
cat("[stats] 06_player_career_pitching\n")
suppressMessages(source("pipelines/05_performance/02_pitching/06_player_career_pitching.R"))
cat("[stats] 08_statcast_pitch_arsenal\n")
suppressMessages(source("pipelines/05_performance/02_pitching/08_statcast_pitch_arsenal.R"))
